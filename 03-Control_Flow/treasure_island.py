...
if choice1 == "left":
   ...
   if choice2 == "wait":
       choice3 = input("You arrive at the island unharmed. There is a house with three doors. One red, one yellow and' "
       ...
       print("You gt attacked b an angry trout. Game Over.")
else:
